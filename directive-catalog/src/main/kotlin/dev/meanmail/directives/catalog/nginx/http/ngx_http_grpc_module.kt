...
val grpcInterceptErrors = ToggleDirective(
    ...
    "Enables or disables error interception for gRPC connections",
    enabled = false,
    context = listOf(http, server, location),
    module = ngx_http_grpc_module
)
...
val grpcSocketKeepalive = ToggleDirective(
    ...
    "Enables or disables socket keepalive for gRPC connections",
    enabled = false,
    context = listOf(http, server, location),
    module = ngx_http_grpc_module
)
...
val grpcSslServerName = ToggleDirective(
    ...
    "Enables or disables the use of the server name for gRPC connections",
    enabled = false,
    context = listOf(http, server, location),
    module = ngx_http_grpc_module
)
...
val grpcSslSessionReuse = ToggleDirective(
    ...
    "Enables or disables SSL/TLS session reuse for gRPC connections",
    enabled = true,
    context = listOf(http, server, location),
    module = ngx_http_grpc_module
)
...
val grpcSslVerify = ToggleDirective(
    "grpc_ssl_verify",
    "Enables or disables SSL/TLS verification for gRPC connections",
    enabled = false,
    context = listOf(http, server, location),
    module = ngx_http_grpc_module
)
