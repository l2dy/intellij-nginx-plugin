...
val accessByLua = Directive(
    ...
    syntax = listOf("<b>access_by_lua</b> <i>lua-script-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "code",
...
val accessByLuaBlock = Directive(
    ...
    description = "Executes Lua code during the access phase",
    syntax = listOf("<b>access_by_lua_block</b> { ... }"),
...
val accessByLuaFile = Directive(
    ...
    syntax = listOf("<b>access_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
...
val balancerByLuaBlock = Directive(
    ...
    syntax = listOf("<b>balancer_by_lua_block</b> { ... }"),
    parameters = emptyList(),
...
val balancerByLuaFile = Directive(
    ...
    syntax = listOf("<b>balancer_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val balancerKeepalive = Directive(
    ...
    syntax = listOf("<b>balancer_keepalive</b> <i>total-connections</i>;"),
    parameters = listOf(
        DirectiveParameter(
...
val bodyFilterByLua = Directive(
    ...
    syntax = listOf("<b>body_filter_by_lua</b> <i>lua-script-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "code",
            description = "Lua code to execute",
...
val bodyFilterByLuaBlock = Directive(
    ...
    description = "Executes Lua code during the body filter phase",
    syntax = listOf("<b>body_filter_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http, locationIf, location, server),
    module = lua_nginx_module
)
...
val bodyFilterByLuaFile = Directive(
    ...
    syntax = listOf("<b>body_filter_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val contentByLua = Directive(
    ...
    syntax = listOf("<b>content_by_lua</b> <i>lua-script-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "code",
            description = "Lua code to execute",
...
val contentByLuaBlock = Directive(
    ...
    description = "Executes Lua code as content handler",
    syntax = listOf("<b>content_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(locationIf, location),
    module = lua_nginx_module
)
...
val contentByLuaFile = Directive(
    ...
    syntax = listOf("<b>content_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val exitWorkerByLuaBlock = Directive(
    ...
    syntax = listOf("<b>exit_worker_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http),
    module = lua_nginx_module
)
...
val exitWorkerByLuaFile = Directive(
    ...
    syntax = listOf("<b>exit_worker_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val headerFilterByLua = Directive(
    ...
    syntax = listOf("<b>header_filter_by_lua</b> <i>lua-script-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "code",
            description = "Lua code to execute",
...
val headerFilterByLuaBlock = Directive(
    ...
    description = "Executes Lua code during the header filter phase",
    syntax = listOf("<b>header_filter_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http, locationIf, location, server),
    module = lua_nginx_module
)
...
val headerFilterByLuaFile = Directive(
    ...
    syntax = listOf("<b>header_filter_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val initByLua = Directive(
    ...
    syntax = listOf("<b>init_by_lua</b> <i>lua-script-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "code",
            description = "Lua code to execute",
...
val initByLuaBlock = Directive(
    ...
    description = "Executes Lua code when Nginx starts up",
    syntax = listOf("<b>init_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http),
    module = lua_nginx_module
)
...
val initByLuaFile = Directive(
    ...
    syntax = listOf("<b>init_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val initWorkerByLua = Directive(
    ...
    syntax = listOf("<b>init_worker_by_lua</b> <i>lua-script-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "code",
            description = "Lua code to execute",
...
val initWorkerByLuaBlock = Directive(
    ...
    description = "Executes Lua code when a worker process starts",
    syntax = listOf("<b>init_worker_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http),
    module = lua_nginx_module
)
...
val initWorkerByLuaFile = Directive(
    ...
    syntax = listOf("<b>init_worker_by_lua_file</b> <i>lua-file-path</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val logByLua = Directive(
    ...
    syntax = listOf("<b>log_by_lua</b> <i>lua-script-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "code",
            description = "Lua code to execute",
...
val logByLuaBlock = Directive(
    ...
    description = "Executes Lua code during the logging phase",
    syntax = listOf("<b>log_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http, locationIf, location, server),
    module = lua_nginx_module
)
...
val logByLuaFile = Directive(
    ...
    syntax = listOf("<b>log_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val luaCaptureErrorLog = Directive(
    ...
    syntax = listOf("<b>lua_capture_error_log</b> <i>size</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "size",
...
val luaMallocTrim = Directive(
    ...
    syntax = listOf("<b>lua_malloc_trim</b> <i>request-count</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "request_count",
...
val luaMaxPendingTimers = Directive(
    ...
    syntax = listOf("<b>lua_max_pending_timers</b> <i>count</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "count",
...
val luaMaxRunningTimers = Directive(
    ...
    syntax = listOf("<b>lua_max_running_timers</b> <i>count</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "count",
...
val luaPackageCpath = Directive(
    ...
    syntax = listOf("<b>lua_package_cpath</b> <i>lua-style-cpath-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "path",
...
val luaPackagePath = Directive(
    ...
    syntax = listOf("<b>lua_package_path</b> <i>lua-style-path-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "path",
...
val luaRegexCacheMaxEntries = Directive(
    ...
    syntax = listOf("<b>lua_regex_cache_max_entries</b> <i>num</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "number",
...
val luaRegexMatchLimit = Directive(
    ...
    syntax = listOf("<b>lua_regex_match_limit</b> <i>num</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "number",
...
val luaSharedDict = Directive(
    ...
    syntax = listOf("<b>lua_shared_dict</b> <i>name</i> <i>size</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "name",
...
val luaSocketBufferSize = Directive(
    ...
    syntax = listOf("<b>lua_socket_buffer_size</b> <i>size</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "size",
...
val luaSocketConnectTimeout = Directive(
    ...
    syntax = listOf("<b>lua_socket_connect_timeout</b> <i>time</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "timeout",
...
val luaSocketKeepaliveTimeout = Directive(
    ...
    syntax = listOf("<b>lua_socket_keepalive_timeout</b> <i>time</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "timeout",
...
val luaSocketPoolSize = Directive(
    ...
    syntax = listOf("<b>lua_socket_pool_size</b> <i>size</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "size",
...
val luaSocketReadTimeout = Directive(
    ...
    syntax = listOf("<b>lua_socket_read_timeout</b> <i>time</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "timeout",
...
val luaSocketSendLowat = Directive(
    ...
    syntax = listOf("<b>lua_socket_send_lowat</b> <i>size</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "size",
...
val luaSocketSendTimeout = Directive(
    ...
    syntax = listOf("<b>lua_socket_send_timeout</b> <i>time</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "timeout",
...
val luaSslCertificate = Directive(
    ...
    syntax = listOf("<b>lua_ssl_certificate</b> <i>file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
...
val luaSslCertificateKey = Directive(
    ...
    syntax = listOf("<b>lua_ssl_certificate_key</b> <i>file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
...
val luaSslCiphers = Directive(
    ...
    syntax = listOf("<b>lua_ssl_ciphers</b> <i>ciphers</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "ciphers",
...
val luaSslConfCommand = Directive(
    ...
    syntax = listOf("<b>lua_ssl_conf_command</b> <i>command</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "command",
...
val luaSslCrl = Directive(
    ...
    syntax = listOf("<b>lua_ssl_crl</b> <i>file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
...
val luaSslProtocols = Directive(
    ...
    syntax = listOf("<b>lua_ssl_protocols</b> [SSLv2] [SSLv3] [TLSv1] [TLSv1.1] [TLSv1.2] [TLSv1.3];"),
    parameters = listOf(
        DirectiveParameter(
            name = "protocols",
...
val luaSslTrustedCertificate = Directive(
    ...
    syntax = listOf("<b>lua_ssl_trusted_certificate</b> <i>file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
...
val luaSslVerifyDepth = Directive(
    ...
    syntax = listOf("<b>lua_ssl_verify_depth</b> <i>number</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "depth",
...
val luaSslKeyLog = Directive(
    ...
    syntax = listOf("<b>lua_ssl_key_log</b> <i>file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
...
val precontentByLuaBlock = Directive(
    ...
    syntax = listOf("<b>precontent_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http, locationIf, location, server),
    module = lua_nginx_module
)
...
val precontentByLuaFile = Directive(
    ...
    syntax = listOf("<b>precontent_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val proxySslCertificateByLuaBlock = Directive(
    ...
    syntax = listOf("<b>proxy_ssl_certificate_by_lua_block</b> { ... }"),
    parameters = emptyList(),
...
val proxySslCertificateByLuaFile = Directive(
    ...
    syntax = listOf("<b>proxy_ssl_certificate_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val proxySslVerifyByLuaBlock = Directive(
    ...
    syntax = listOf("<b>proxy_ssl_verify_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(location),
    module = lua_nginx_module
)
...
val proxySslVerifyByLuaFile = Directive(
    ...
    syntax = listOf("<b>proxy_ssl_verify_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
...
val luaThreadCacheMaxEntries = Directive(
    ...
    syntax = listOf("<b>lua_thread_cache_max_entries</b> <i>num</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "number",
...
val luaWorkerThreadVmPoolSize = Directive(
    ...
    syntax = listOf("<b>lua_worker_thread_vm_pool_size</b> <i>size</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "size",
...
val rewriteByLua = Directive(
    ...
    syntax = listOf("<b>rewrite_by_lua</b> <i>lua-script-str</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "code",
            description = "Lua code to execute",
...
val rewriteByLuaBlock = Directive(
    ...
    description = "Executes Lua code during the rewrite phase",
    syntax = listOf("<b>rewrite_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http, locationIf, location, server),
    module = lua_nginx_module
)
...
val rewriteByLuaFile = Directive(
    ...
    syntax = listOf("<b>rewrite_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val serverRewriteByLuaBlock = Directive(
    ...
    syntax = listOf("<b>server_rewrite_by_lua_block</b> { ... }"),
    parameters = emptyList(),
...
val serverRewriteByLuaFile = Directive(
    ...
    syntax = listOf("<b>server_rewrite_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val setByLua = Directive(
    ...
    syntax = listOf("<b>set_by_lua</b> <i>\$res</i> <i>lua-script-str</i> [<i>\$arg1</i> <i>\$arg2</i> ...];"),
    parameters = listOf(
        DirectiveParameter(
            name = "variable",
...
val setByLuaBlock = Directive(
    ...
    description = "Executes Lua code and sets a variable",
    syntax = listOf("<b>set_by_lua_block</b> <i>\$res</i> { ... }"),
    parameters = listOf(
        DirectiveParameter(
            name = "variable",
            description = "Variable to set",
...
val setByLuaFile = Directive(
    ...
    syntax = listOf("<b>set_by_lua_file</b> <i>\$res</i> <i>path-to-lua-script-file</i> [<i>\$arg1</i> <i>\$arg2</i> ...];"),
    parameters = listOf(
        DirectiveParameter(
            name = "variable",
            description = "Variable to set",
...
val sslCertificateByLuaBlock = Directive(
    ...
    syntax = listOf("<b>ssl_certificate_by_lua_block</b> { ... }"),
    parameters = emptyList(),
...
val sslCertificateByLuaFile = Directive(
    ...
    syntax = listOf("<b>ssl_certificate_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val sslClientHelloByLuaBlock = Directive(
    ...
    syntax = listOf("<b>ssl_client_hello_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http, server),
    module = lua_nginx_module
)
...
val sslClientHelloByLuaFile = Directive(
    ...
    syntax = listOf("<b>ssl_client_hello_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val sslSessionFetchByLuaBlock = Directive(
    ...
    syntax = listOf("<b>ssl_session_fetch_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http),
    module = lua_nginx_module
)
...
val sslSessionFetchByLuaFile = Directive(
    ...
    syntax = listOf("<b>ssl_session_fetch_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
...
val sslSessionStoreByLuaBlock = Directive(
    ...
    syntax = listOf("<b>ssl_session_store_by_lua_block</b> { ... }"),
    parameters = emptyList(),
    context = listOf(http),
    module = lua_nginx_module
)
...
val sslSessionStoreByLuaFile = Directive(
    ...
    syntax = listOf("<b>ssl_session_store_by_lua_file</b> <i>path-to-lua-script-file</i>;"),
    parameters = listOf(
        DirectiveParameter(
            name = "file",
            description = "Path to the Lua file to execute",
